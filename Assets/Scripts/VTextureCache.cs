...
public class VTextureCache
{
    private string m_filePath;
    private string m_fileName;

    private const int ComponentSize = 3;
    private const int ComponentCount = 1;
    ...
    public VTextureCache(int size, string path, string name)
    {
        Size = size;
        m_fileName = name;
        m_filePath = path;
    ...
    public void SetPixel(int x, int y, int blockWidth, int blockHeight, byte[] colors)
    {
